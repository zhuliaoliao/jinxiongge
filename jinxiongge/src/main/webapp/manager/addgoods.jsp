		...
		<div class="page-content">
			<div class="panel-lg panel panel-default">
				...
				<div class="panel-body">
					<div class="row">
						<div class="col-xs-12">
							<form action="/jinxiongge/goods/add.do" method="post" enctype="multipart/form-data" role="form" data-form-sync="#form_consentnewnumber" class="form form-register" id="form_accountsetting" name="form_accountsetting" data-required-symbol="*" novalidate="novalidate">
									...
									<div class="row">
										<div class="col-xs-12">
											 <div class="form-group">
												 ...
												 <input type="text" class="form-control input-lg required" id="form_accountsetting_usernamee" name="goodsname"  aria-required="true">
									...
									<div class="row">
										<div class="col-xs-12">
											 <div class="form-group">
												 ...
												 <input type="text" class="form-control input-lg required" id="form_accountsetting_pwd" name="introduce"  aria-required="true">
									...
									<div class="row">
										<div class="col-xs-12">
											 <div class="form-group">
												 ...
												 <input type="text" class="form-control input-lg required" id="form_accountsetting_truename" name="price"  aria-required="true">
									...
									<div class="row">
										<div class="col-xs-12">
											 <div class="form-group">
												 ...
												 <input type="text" class="form-control input-lg required" id="form_accountsetting_tel" name="nowprice"  aria-required="true">
										...
										<div class="col-xs-12">
											 <div class="form-group">
												 ...
												 <label class="field-label" for="form_accountsetting_sex">请输入yes或no:</label>
												  <input type="text" class="form-control input-lg required" id="form_accountsetting_tel" name="specialprice"  aria-required="true">
