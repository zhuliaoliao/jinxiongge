...
<html class=" js flexbox canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths no-ieolderthan9"><!--<![endif]--><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<script type="text/javascript" src="/jinxiongge/js/freeze.js"></script>
...
<div class="root">
	<div class="wrap container">
		...
		<div class="page-content">
			...
			<!-- for循环 -->			
	<c:if test="${userspage!=null}">
	
<%-- 				<ul class="menu">
	<c:forEach items="${userspage}" var="item">				
				
		<li class="menu-item">
		
		<a class="menu-item-target" href="/jinxiongge/goods/userspage.do?status=1">繁华订餐 </a>
		</li>
...
-->
		...
		<table class="table-default" border="2"  >
			...
			<tr>
				...
				<td align="center">
				<font color="blue">用户名</font>
				</td>
				<td align="center">
				<font color="blue">手机</font>
				</td>
				<td align="center">
				<font color="blue">真名</font>
				</td>
				<td align="center">
				...
				<td align="center">
				<font color="blue">城市</font>
				</td>
				<td align="center">
				<font color="blue">email</font>
				</td>
				<td align="center">
				<font color="blue">是否冻结</font>
				</td>
			</tr>
			
	<c:forEach items="${userspage}" var="item" varStatus="status">	
			...
			<tr bgcolor="#FFFCC6">
				...
				<td scope="row" style="padding-left:16px">${item.uid}</td>
				...
				<td align="center">
			<c:if test="${item.freeze==0}">
			<a  onclick="freeze(${item.uid},1)">冻结</a>
			</c:if>
			<c:if test="${item.freeze==1}">
			<a  onclick="freeze(${item.uid},0)">解冻</a>
			</c:if>
	...
	<!-- for循环 -->					
				...
				<font size="3" ><a href="/jinxiongge/user/userspage.do?page=1">首页 &nbsp &nbsp</a></font>
				<font size="3" ><a href="/jinxiongge/user/userspage.do?page=${userspagePaginator.prePage}">上一页: ${userspagePaginator.prePage} &nbsp &nbsp</a></font>
				<font size="3" ><a href="/jinxiongge/user/userspage.do?page=${userspagePaginator.nextPage}">下一页: ${userspagePaginator.nextPage}  &nbsp&nbsp</a></font>
				<font size="3" ><a href="/jinxiongge/user/userspage.do?page=${userspagePaginator.page}">当前页: ${userspagePaginator.page} &nbsp&nbsp</a></font>
				<font size="3" ><a href="/jinxiongge/user/userspage.do?page=${userspagePaginator.totalPages}">末页 &nbsp&nbsp</a></font>
				<font size="3" > 总页数: ${userspagePaginator.totalPages} </font> &nbsp&nbsp
				<font size="3" > 您的订单总数: ${userspagePaginator.totalCount} </font> 
				</div>
