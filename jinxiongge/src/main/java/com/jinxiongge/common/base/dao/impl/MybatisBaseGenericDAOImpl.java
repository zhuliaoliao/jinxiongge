package com.jinxiongge.common.base.dao.impl;
...
import com.jinxiongge.bean.util.BeanMapUtil;
import com.jinxiongge.common.base.dao.IBaseGenericDAO;
import com.jinxiongge.common.base.page.GenericDefaultPage;
import com.jinxiongge.common.base.page.IGenericPage;
import com.jinxiongge.dao.exception.BaseDaoException;
/**
...
implements IBaseGenericDAO<T, ID> {
	...
	protected String getDefaultSqlNamespace() {
		return ReflectGeneric.getClassGenricType(this.getClass()).getName();
	}
	...
	@SuppressWarnings("unchecked")
	public PageList<T> commonPage(String statement, Map<String, Object> paramts, RowBounds rowBounds){
		return  (PageList<T>)this.getSqlSession().selectList(getSqlName(statement),paramts, rowBounds);
		
	}
	
	@SuppressWarnings("unchecked")
	public List<T> commonPageNoTotalCount(String statement, Map<String, Object> paramts, RowBounds rowBounds){
		return  (List<T>)this.getSqlSession().selectList(getSqlName(statement),paramts, rowBounds);
